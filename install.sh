...
echo
RUTA=https://raw.githubusercontent.com/PIBSAS/Recalbox9.1-Pulstar/main/bios/
...
echo "APPLE IIGS"
echo
wget -c "${RUTA}apple2gs1.rom" -P ../bios/
echo
echo
wget -c "${RUTA}apple2gs3.rom" -P ../bios/
echo
echo "APPLE MACINTOSH"
echo
wget -c "${RUTA}macintosh/MacII.ROM" -P ../bios/macintosh/
echo
wget -c "${RUTA}macintosh/MinivMacBootv2.dsk" -P ../bios/macintosh/
echo
echo "ATARI 5200"
echo
...
echo "ATARI 7800"
echo
wget -c "${RUTA}7800 BIOS (U).rom" -P ../bios/
echo
wget -c "${RUTA}7800 BIOS (E).rom" -P ../bios/
echo
echo "ATARI 8BITS"
echo
...
echo
wget -c "${RUTA}atarist/st.img" -P ../bios/atarist/
echo
wget -c "${RUTA}atarist/ste.img" -P ../bios/atarist/
echo
wget -c "${RUTA}atarist/megaste.img" -P ../bios/atarist/
echo
wget -c "${RUTA}atarist/tt.img" -P ../bios/atarist/
echo
wget -c "${RUTA}atarist/falcon.img" -P ../bios/atarist/
echo
...
echo
wget -c "${RUTA}coleco/boot.rom" -P ../bios/coleco/
echo
echo "COMMODORE 64"
echo
wget -c "${RUTA}vice/JiffyDOS_C64.bin" -P ../bios/vice/
echo
wget -c "${RUTA}vice/JiffyDOS_C128.bin" -P ../bios/vice/
echo
wget -c "${RUTA}vice/JiffyDOS_1541-II.bin" -P ../bios/vice/
echo
wget -c "${RUTA}vice/JiffyDOS_1571_repl310654.bin" -P ../bios/vice/
echo
wget -c "${RUTA}vice/JiffyDOS_1581.bin" -P ../bios/vice/
echo
wget -c "${RUTA}vice/SCPU64/scpu-dos-1.4.bin" -P ../bios/vice/SCPU64/
echo
wget -c "${RUTA}vice/SCPU64/scpu-dos-2.04.bin" -P ../bios/vice/SCPU64/
echo
echo "DRAGON 32/64"
echo
wget -c "${RUTA}dragon/d32.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/d64rom1.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/d64rom2.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/d64tano.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/d64tano2.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/d200rom1.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/d200rom2.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/ddos10.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/ddos11c.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/ddos12a.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/ddos40.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/ddos42.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/deltados.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/dplus48.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/dplus49b.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/dplus50.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/sdose6.rom" -P ../bios/dragon/
echo
wget -c "${RUTA}dragon/sdose8.rom" -P ../bios/dragon/
echo
echo "DREAMCAST"
echo
...
echo
wget -c "${RUTA}dc/dc_flash.bin" -P ../bios/dc/
echo
echo "ELEKTRONIKA BK"
echo
...
echo "NEC PC-ENGINE"
echo
wget -c "${RUTA}gexpress.pce" -P ../bios/
echo
echo "NEC PC-ENGINE CD"
echo
wget -c "${RUTA}syscard3.pce" -P ../bios/
echo
wget -c "${RUTA}syscard1.pce" -P ../bios/
echo
wget -c "${RUTA}syscard2.pce" -P ../bios/
echo
...
echo
wget -c "${RUTA}dc/airlbios.zip" -P ../bios/dc/
echo
wget -c "${RUTA}dc/hod2bios.zip" -P ../bios/dc/
echo
echo "NAOMI GD-ROM"
echo
wget -c "${RUTA}dc/naomigd.zip" -P ../bios/dc/
echo
echo "NINTENDO 64DD"
echo
wget -c "${RUTA}64DD_IPL.bin" -P ../bios/
echo
wget -c "${RUTA}Mupen64plus/IPL.n64" -P ../bios/Mupen64plus/
echo
echo "NINTENDO DS"
echo
...
echo
wget -c "${RUTA}gamecube/EUR/IPL.bin" -P ../bios/gamecube/EUR/
echo
wget -c "${RUTA}gamecube/JAP/IPL.bin" -P ../bios/gamecube/JAP/
echo
wget -c "${RUTA}gamecube/USA/IPL.bin" -P ../bios/gamecube/USA/
echo
...
echo
wget -c "${RUTA}sgb/SGB1.sfc" -P ../bios/sgb/
echo
echo
wget -c "${RUTA}sgb/SGB2.sfc" -P ../bios/sgb/
echo
echo "PC-8800 SERIES"
echo
wget -c "${RUTA}quasi88/n88.rom" -P ../bios/quasi88/
echo
wget -c "${RUTA}quasi88/n88_0.rom" -P ../bios/quasi88/
echo
wget -c "${RUTA}quasi88/n88_1.rom" -P ../bios/quasi88/
echo
wget -c "${RUTA}quasi88/n88_2.rom" -P ../bios/quasi88/
echo
wget -c "${RUTA}quasi88/n88_3.rom" -P ../bios/quasi88/
echo
wget -c "${RUTA}quasi88/n88n.rom" -P ../bios/quasi88/
echo
wget -c "${RUTA}quasi88/disk.rom" -P ../bios/quasi88/
echo
...
echo
wget -c "${RUTA}np2kai/2608_bd.wav" -P ../bios/np2kai/
echo
wget -c "${RUTA}np2kai/2608_hh.wav" -P ../bios/np2kai/
echo
wget -c "${RUTA}np2kai/2608_rim.wav" -P ../bios/np2kai/
echo
wget -c "${RUTA}np2kai/2608_sd.wav" -P ../bios/np2kai/
echo
wget -c "${RUTA}np2kai/2608_tom.wav" -P ../bios/np2kai/
echo
wget -c "${RUTA}np2kai/2608_top.wav" -P ../bios/np2kai/
echo
echo "PALM PILOT"
echo
wget -c "${RUTA}palmos41-en-m515.rom" -P ../bios/
echo
wget -c "${RUTA}bootloader-dbvz.rom" -P ../bios/
echo
echo "PANASONIC 3DO"
echo
wget -c "${RUTA}panafz1.bin" -P ../bios/
echo
wget -c "${RUTA}panafz1j.bin" -P ../bios/
echo
wget -c "${RUTA}panafz1j-norsa.bin" -P ../bios/
echo
wget -c "${RUTA}panafz10.bin" -P ../bios/
echo
wget -c "${RUTA}panafz10-norsa.bin" -P ../bios/
echo
wget -c "${RUTA}panafz10e-anvil.bin" -P ../bios/
echo
wget -c "${RUTA}panafz10e-anvil-norsa.bin" -P ../bios/
echo
wget -c "${RUTA}goldstar.bin" -P ../bios/
echo
wget -c "${RUTA}sanyotry.bin" -P ../bios/
echo
wget -c "${RUTA}3do_arcade_saot.bin" -P ../bios/
echo
wget -c "${RUTA}panafz1-kanji.bin" -P ../bios/
echo
wget -c "${RUTA}panafz1j-kanji.bin" -P ../bios/
echo
wget -c "${RUTA}panafz10ja-anvil-kanji.bin" -P ../bios/
echo
echo "PENTAGON 128/512/1024 (ZX SPECTRUM CLONE)"
echo
wget -c "${RUTA}fuse/128p-0.rom" -P ../bios/fuse/
echo
wget -c "${RUTA}fuse/128p-1.rom" -P ../bios/fuse/
echo
wget -c "${RUTA}fuse/gluck.rom" -P ../bios/fuse/
echo
wget -c "${RUTA}fuse/trdos.rom" -P ../bios/fuse/
echo
echo "PHILIPS CD-I"
echo
wget -c "${RUTA}cdi/cdimono1.zip" -P ../bios/cdi/
echo
wget -c "${RUTA}cdi/cdibios.zip" -P ../bios/cdi/
echo
wget -c "${RUTA}cdi/cdimono2.zip" -P ../bios/cdi/
echo
echo "PLAYSTATION"
echo
...
echo
wget -c "${RUTA}ps1_rom.bin" -P ../bios/
echo
echo "PLAYSTATION 2"
echo
wget -c "${RUTA}ps2/ps2-0230a-20080220.bin" -P ../bios/ps2/
echo
wget -c "${RUTA}ps2/ps2-0230e-20080220.bin" -P ../bios/ps2/
echo
wget -c "${RUTA}ps2/ps2-0230h-20080220.bin" -P ../bios/ps2/
echo
wget -c "${RUTA}ps2/ps2-0230j-20080220.bin" -P ../bios/ps2/
echo
echo "POKEMON MINI"
echo
wget -c "${RUTA}bios.min" -P ../bios/
echo
echo "SNK NEO-GEO"
echo
wget -c "${RUTA_DUE}neogeo.zip" -P ../roms/neogeo/
echo
echo "SNK NEO-GEO CD"
echo
wget -c "${RUTA}neogeo.zip" -P ../bios/
echo
wget -c "${RUTA}neocdz.zip" -P ../bios/
echo
...
echo
wget -c "${RUTA}neocd/000-lo.lo" -P ../bios/neocd/
echo
wget -c "${RUTA}neocd/ng-lo.rom" -P ../bios/neocd/
echo
...
echo
wget -c "${RUTA}fuse/256s-0.rom" -P ../bios/fuse/
echo
wget -c "${RUTA}fuse/256s-1.rom" -P ../bios/fuse/
echo
wget -c "${RUTA}fuse/256s-2.rom" -P ../bios/fuse/
echo
wget -c "${RUTA}fuse/256s-3.rom" -P ../bios/fuse/
echo
echo "SEGA GAMEGEAR"
echo
wget -c "${RUTA}bios.gg" -P ../bios/
echo
echo "SEGA MEGA CD"
echo
...
echo
wget -c "${RUTA}bios_E.sms" -P ../bios/
echo
wget -c "${RUTA}bios_U.sms" -P ../bios/
echo
wget -c "${RUTA}bios_J.sms" -P ../bios/
echo
echo "SEGA MEGADRIVE/GENESIS"
echo
wget -c "${RUTA}bios_MD.bin" -P ../bios/
echo
echo "SEGA SATURN"
echo
wget -c "${RUTA}saturn_bios.bin" -P ../bios/
echo
wget -c "${RUTA}stvbios.zip" -P ../bios/
echo
...
echo
wget -c "${RUTA}keropi/iplrom30.dat" -P ../bios/keropi/
echo
wget -c "${RUTA}keropi/iplromco.dat" -P ../bios/keropi/
echo
wget -c "${RUTA}keropi/iplromxv.dat" -P ../bios/keropi/
echo
echo "SPECTRAVIDEO"
echo
...
echo
wget -c "${RUTA}trs80coco/bas10.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/bas11.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/bas12.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/bas13.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/extbas10.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/extbas11.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/mx1600bas.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/disk10.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/disk11.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/hdbdw3bck.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/mc10.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/coco3.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/coco3p.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/alice32.rom" -P ../bios/trs80coco/
echo
wget -c "${RUTA}trs80coco/alice4k.rom" -P ../bios/trs80coco/
echo
echo "TANGERINE ORIC/ATMOS"
echo
wget -c "${RUTA}oricutron/basic11b.rom" -P ../bios/oricutron/
echo
wget -c "${RUTA}oricutron/basic10.rom" -P ../bios/oricutron/
echo
wget -c "${RUTA}oricutron/bd500.rom" -P ../bios/oricutron/
echo
wget -c "${RUTA}oricutron/jasmin.rom" -P ../bios/oricutron/
echo
wget -c "${RUTA}oricutron/microdis.rom" -P ../bios/oricutron/
echo
wget -c "${RUTA}oricutron/pravetzt.rom" -P ../bios/oricutron/
echo
wget -c "${RUTA}oricutron/8dos2.rom" -P ../bios/oricutron/
echo
wget -c "${RUTA}oricutron/teleass.rom" -P ../bios/oricutron/
echo
wget -c "${RUTA}oricutron/hyperbas.rom" -P ../bios/oricutron/
echo
wget -c "${RUTA}oricutron/telmon24.rom" -P ../bios/oricutron/
echo
echo "TEXAS INSTRUMENT TI-99/4A"
echo
wget -c "${RUTA}ti994a/TI-994A.ctg" -P ../bios/ti994a/
echo
wget -c "${RUTA}ti994a/spchrom.bin" -P ../bios/ti994a/
echo
wget -c "${RUTA}ti994a/ti-disk.ctg" -P ../bios/ti994a/
echo
echo "VIDEOPAC+"
echo
